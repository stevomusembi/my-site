                    ...
                    <div className="grid grid-cols-1 gap-4 mt-5 py-4 lg:px-4">
                        {projects.map((project, index) => (
                            <div key={index} className="p-2 lg:p-8">
                                <div className="flex flex-col md:flex-row m-2 p-4 bg-gray-100 shadow-2xl md:mt-2">
                                    ...
                                    <div className="flex flex-col md:w-1/2 md:pl-4 py-2 px-2">
                                        ...
                                        <div className="flex mt-4 md:mt-auto space-x-4">
                                            <a href={project.githubLink} className="text-gray-950 hover:text-blue-800 cursor-pointer" target="_blank" rel="noopener noreferrer">
                                                <FontAwesomeIcon icon={faGithub} /> GitHub
                                            </a>
                                            <a href={project.link} className="text-gray-950  hover:text-blue-800 cursor-pointer" target="_blank" rel="noopener noreferrer">
